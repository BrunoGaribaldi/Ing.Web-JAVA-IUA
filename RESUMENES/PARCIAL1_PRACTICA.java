   ...
   -------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< 
       ...
       CLASE 3-4-23
        ...
        static tipo_de_dato_que_devuelve nombre (datos que ingresan )  pongo static para no tener que generar una nueva instancia de la clase para poder llamarla
    ...
    public static void main(String[] args) {
        ...
        PAQUETES
        namespace --> varias clases pueden tener el mismo nombre mientras esten en distintos paquetes.
        el codigo fuente debe arrancar con package nombre.
        
        IMPORTAR CLASES DE OTROS PAQUETES.
        hay que usar la sentencia import.
        por ejemplo java.util.scanner
        ...
        usamos la sentencia extends
        public class nombre_clase extends nombre clase a heredar.
        
        tanto los atributos como los métodos se heredan
